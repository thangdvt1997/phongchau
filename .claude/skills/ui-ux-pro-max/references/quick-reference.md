...
Fetched verbatim from https://github.com/nextlevelbuilder/ui-ux-pro-max-skill
(`.claude/skills/ui-ux-pro-max/references/quick-reference.md`) for offline/local use in this
project, since the upstream skill's Python search tool requires an npm-installed CLI not
