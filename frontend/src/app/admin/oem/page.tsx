          ...
          <div className="overflow-x-auto">
            <table className="min-w-full divide-y divide-gray-200 text-sm">
              <thead className="bg-gray-50">
                <tr>
                  <th className="px-4 py-2.5 text-left text-xs font-semibold uppercase tracking-wide text-gray-500">Request #</th>
                  <th className="px-4 py-2.5 text-left text-xs font-semibold uppercase tracking-wide text-gray-500">Customer / Company</th>
                  <th className="px-4 py-2.5 text-left text-xs font-semibold uppercase tracking-wide text-gray-500">Product Type</th>
                ...
                {requests.map((r) => (
                  <tr key={r.id} className="transition-colors hover:bg-gray-50">
                    <td className="px-4 py-2.5">
                      <Link href={`/admin/oem/${r.id}`} className="font-medium text-teal-700 hover:text-teal-800 hover:underline">
                        {r.requestNumber}
                      </Link>
                    </td>
                    ...
                    <td className="px-4 py-2.5 text-gray-700">{r.productType}</td>
                    <td className="px-4 py-2.5">
